...
public class PacienteRequestDto
{
   ...
   [Required(ErrorMessage = "El campo {0} es requerido")]
   [MaxLength(150,
     ErrorMessage = "Los apellidos no debe pasar de {1} caracteres")]
   public string Apellidos { get; set; } = string.Empty;

   [Required(ErrorMessage = "El campo {0} es requerido")]
   [MaxLength(10,
     ErrorMessage = "El campo Sexo debe tener un máximo {1} caracteres")]
   public string Sexo { get; set; } = string.Empty;

   [Required(ErrorMessage = "Ingrese un número de historia")]
   [MaxLength(1000,
     ErrorMessage = "El num. Historia debe tener un máximo {1} caracteres")]
   public string NumHistoria { get; set; } = string.Empty;

   [Required(ErrorMessage = "El campo Cédula es requerido")]
   [MaxLength(10,
     ErrorMessage = "La cédula debe tener un máximo {1} caracteres")]
   [MinLength(10,
   ...
   [MaxLength(300,
     ErrorMessage = "La dirección no debe pasar de {1} caracteres")]
