...
namespace MedicDate.DataAccess.Migrations
{
    ...
    [Migration("20210730050602_AddCitaAndRelatedEntitiesToDb")]
    partial class AddCitaAndRelatedEntitiesToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicDate.DataAccess.Models.ArchivoCita", b =>
                {
                    b.Property<string>("CitaId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("CitaId", "ArchivoId");

                    b.HasIndex("ArchivoId");

                    b.ToTable("ArchivoCita");
                });
            ...
            modelBuilder.Entity("MedicDate.DataAccess.Models.ArchivoCita", b =>
                {
                    b.HasOne("MedicDate.DataAccess.Models.Archivo", "Archivo")
                        .WithMany("ArchivosCitas")
            ...
            modelBuilder.Entity("MedicDate.DataAccess.Models.Actividad", b =>
                {
                    b.Navigation("ActividadeCitas");
                });

            modelBuilder.Entity("MedicDate.DataAccess.Models.Archivo", b =>
                {
                    b.Navigation("ArchivosCitas");
                });
