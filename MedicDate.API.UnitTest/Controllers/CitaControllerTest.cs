...
public class CitaControllerTest
{
    public class GetCitaDetailsAsync : CitaControllerTest
    {
        ...
        public async Task DebeRetornarLaCitaRequeridaPorElId()
        {
            ...
            cfg.CreateMap<Cita, CitaDetailsDto>().ReverseMap());
            ...
            citaRepoMock.Setup(x => x.FirstOrDefaultAsync(It.IsAny<Expression<Func<Cita, bool>>>(), It.IsAny<string>(), It.IsAny<bool>()))
                .ReturnsAsync(tempCita);
            citaRepoMock.Setup(x => x.ResourceExists(It.IsAny<string>()))
                .ReturnsAsync(true);
            var citaRepo = citaRepoMock.Object;

            var citaController = new CitaController(citaRepo, mapper);
