...
public class AccountControllerTest : BaseDbTest
{
    ...
    private readonly LoginRequestDto _invalidLoginRequest = new()
    {
      ...
      IServiceProvider? serviceProvider = null) where TUser : class
    {
            ...
            Lockout =
      {
        ...
        fakeUserTokenProvider.Setup(x => x.GenerateAsync(It.IsAny<string>(),
            It.IsAny<UserManager<TUser>>(), It.IsAny<TUser>()))
    ...
    public class LoginAsync : AccountControllerTest
    {
          ...
          Should_return_propper_error_LoginResponseDto_when_Login_fails()
        {
            ...
            Assert.Equal("Inicio de sesión incorrecto.",
              loginResultDto?.ErrorMessage);
        }
